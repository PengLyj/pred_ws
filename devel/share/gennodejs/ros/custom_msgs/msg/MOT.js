...
class MOT {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MOT
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MOT
    let len;
    let data = new MOT(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.array[i] = std_msgs.msg.Float32MultiArray.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.array !== undefined) {
      ...
      for (let i = 0; i < resolved.array.length; ++i) {
        resolved.array[i] = std_msgs.msg.Float32MultiArray.Resolve(msg.array[i]);
      }
    }
    else {
      resolved.array = []
