...
"""autogenerated by genpy from custom_msgs/MOT.msg. Do not edit."""
import codecs
import sys
...
class MOT(genpy.Message):
  _md5sum = "8d34b3cd50c5972122d057a82374fbc4"
  _type = "custom_msgs/MOT"
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['header','num','array']
  _slot_types = ['std_msgs/Header','int32','std_msgs/Float32MultiArray[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MOT, self).__init__(*args, **kwds)
