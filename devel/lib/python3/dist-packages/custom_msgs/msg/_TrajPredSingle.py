...
"""autogenerated by genpy from custom_msgs/TrajPredSingle.msg. Do not edit."""
import codecs
import sys
...
class TrajPredSingle(genpy.Message):
  _md5sum = "10e9f71602422d72b4d2dcbad941f70d"
  _type = "custom_msgs/TrajPredSingle"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# 当前时刻下单目标轨迹序列
...
float64 y
float64 z"""
  __slots__ = ['header','array_len','objects','id']
  _slot_types = ['std_msgs/Header','uint32','custom_msgs/DetectedObject[]','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajPredSingle, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.array_len,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.objects = []
