...
"""autogenerated by genpy from custom_msgs/TrajPredArray.msg. Do not edit."""
import codecs
import sys
...
class TrajPredArray(genpy.Message):
  _md5sum = "4ff05079708ce4a441a936a27a5d1121"
  _type = "custom_msgs/TrajPredArray"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# 当前时刻下多目标的轨迹序列
...
float64 y
float64 z"""
  __slots__ = ['header','num_objects','objects']
  _slot_types = ['std_msgs/Header','uint32','custom_msgs/TrajPredSingle[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TrajPredArray, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.num_objects,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.objects = []
      for i in range(0, length):
        val1 = custom_msgs.msg.TrajPredSingle()
        _v15 = val1.header
        start = end
        end += 4
        ...
        (val1.array_len,) = _get_struct_I().unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        val1.objects = []
        for i in range(0, length):
          val2 = custom_msgs.msg.DetectedObject()
          _v17 = val2.header
          start = end
          end += 4
          ...
          (val2.obj_lane_number,) = _get_struct_i().unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
          ...
          if python3:
            val2.label = str[start:end].decode('utf-8', 'rosmsg')
          else:
